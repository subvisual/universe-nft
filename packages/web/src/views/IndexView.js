          ...
          <div>
            ...
            <div data-w-id="5b791318-b617-e57f-9221-88db8217b68e" className="af-class-section af-class-hero af-class-wf-section">
              ...
              <div className="af-class-second-container af-class-hero">
                <div className="af-class-hero-container af-class-stop-phone"><img src="images/Subvisual_arrow.svg" loading="lazy" style={{opacity: 0}} alt="arrow" className="af-class-hero-arrow" />
            ...
            <div id="react-root" className="af-class-section af-class-no-padding-up af-class-wf-section">
