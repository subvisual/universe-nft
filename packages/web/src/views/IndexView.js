...
const scripts = [
  {
    loading: fetch(
      "https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=61c33c9858a987caf6602ade"
    ).then((body) => body.text()),
    isAsync: false,
  },
  {
      ...
      <span>
        ...
        <span className="af-view">
          <div>
            ...
            >
              <h2 style={{ opacity: 0 }} className="load-heading">
                Probably the best gift you will get this year
              </h2>
            </div>
            ...
            <div
              ...
              className="navbar-2 nav-bar w-nav"
              data-easing2="ease-out-quint"
              data-easing="ease-out-quint"
              data-collapse="medium"
              data-w-id="22c507d2-81aa-fb41-e277-2746202e7921"
              role="banner"
              data-no-scroll={1}
              data-duration={700}
              id="navbar"
            ...
            >
              <div
                ...
                data-w-id="c471534b-f3a3-dbd4-ad6e-0d5632ddbe71"
              ...
              <div className="container nav-bar">
                <a
                  href="index.html"
                  aria-current="page"
                  className="nav-brand transition t-home w-nav-brand w--current"
                >
                  <div className="logo-box nav-bar">
                    <img
                      src="images/logo-white.svg"
                      loading="lazy"
                      data-w-id="22c507d2-81aa-fb41-e277-2746202e7925"
                      alt="home link - subvisual logo"
                      className="main-logo white-logo"
                    />
                    <img
                      src="images/symbol-dark.svg"
                      loading="lazy"
                      data-w-id="368d4ba8-be94-e03f-58b9-5c2ff86a2ac7"
                      alt="home link - subvisual logo"
                      className="main-logo dim-grey-logo"
                    />
                    <img
                      src="images/symbol-white.svg"
                      loading="lazy"
                      alt="home link - subvisual logo"
                      className="main-logo white-symbol"
                    />
                  </div>
                </a>
              </div>
            ...
            <div
              data-w-id="5b791318-b617-e57f-9221-88db8217b68e"
              className="section hero wf-section"
            >
              <div className="video-container edge">
                <img
              ...
              <div className="first-container hero">
                <div className="hero-container">
                  <h1 data-w-id="56db997e-04bc-2ac5-cb21-fbbf060aa002">
                    Our universe without u, is kinda niverse 😟
                  </h1>
                </div>
              </div>
              <div className="second-container hero">
                <div className="hero-container stop-phone">
                  <img
                  ...
                  <div
                    style={{
                      WebkitTransform:
                        "translate3d(0, -28px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
                      MozTransform:
                        "translate3d(0, -28px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
                      msTransform:
                        "translate3d(0, -28px, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0) rotateZ(0) skew(0, 0)",
                    ...
                    className="margin-left-40 switch-top-phone"
                  >
                    <p className="color-white">
                      There's more if you scroll a little.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              data-w-id="203a3fe2-dd47-8144-357c-8264319fc900"
              className="section wf-section"
            >
              <div className="container">
                <h2
                  data-w-id="e1152758-d9c0-c7ba-339a-5ef2086dd60c"
                  className="reveal"
                >
                  Let's mark your presence in the universe,{" "}
                  <span className="alternative">with blockchain</span>.
                </h2>
              </div>
              <div className="container">
                <div className="margin-top-40">
                  <div className="background-alice-blue">
            ...
            <div className="section-2 wf-section">
              {map(proxies["wallet-connect-btn"], (props) => (
                <a
                  href="#"
                  {...{
                    ...props,
                    className: `button-2 w-button ${props.className || ""}`,
                  }}
                >
                  {props.children ? (
                    props.children
                  ) : (
                    <React.Fragment>Connect Metamask</React.Fragment>
                  )}
                </a>
              ))}
            </div>
            <GridView.Controller />
            <div
              data-w-id="af83e6be-7ee1-7e00-8f28-f94b864a679b"
              className="section wf-section"
            >
              <div className="container">
                <h2 className="reveal">
                  What you will do up there ⬆️, will show up down here ⬇️
                  <span className="alternative" />
                </h2>
                <div className="margin-top-40">
                  <p className="reveal max-width-442">
                    What could it be? 🤓
                    <br />
                  </p>
                </div>
              ...
              <div className="container nfts">
                <div className="margin-top-40">
                  <div className="img-holder">
                    <img
                      src="images/background-tiles.png"
                      loading="lazy"
                      srcSet="images/background-tiles-p-500.png 500w, images/background-tiles.png 1501w"
                      sizes="(max-width: 479px) 92vw, (max-width: 767px) 95vw, 96vw"
                      alt="A beautiful background made of tiles"
                      className="img"
                    />
                  </div>
                </div>
            ...
            <div
              data-w-id="7a41a91f-44b1-a3d3-4655-747c7af1861b"
              className="reveal"
            />
